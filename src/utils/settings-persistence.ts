...
const SETTINGS_KEY_PREFIXES = [
  ...
  'veritas-monitors',
  'veritas-layers',
  'veritas-disabled-feeds',
  'veritas-live-channels',
  'veritas-map-mode',
  'veritas-variant',
  'veritas-theme',
  'veritas-panel-spans',
  'veritas-panel-order',
  'veritas-runtime-feature-toggles',
  'wm-breaking-alerts-v1',
  'wm-globe-render-scale',
  'wm-live-streams-always-on',
  'wm-font-family',
  'veritas-active-channel',
  'veritas-webcam-prefs',
  'wm-map-theme:',
  'map-height',
  'map-pinned',
...
export function exportSettings(): void {
  ...
  const exportData: ExportedSettings = {
    ...
    variant: localStorage.getItem('veritas-variant') || 'full',
    data,
  };
  ...
  a.download = `veritas-intel-settings-${ts}.json`;
