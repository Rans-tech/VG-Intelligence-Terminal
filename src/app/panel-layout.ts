...
export class PanelLayoutManager implements AppModule {
    ...
    this.ctx.container.innerHTML = `
      ...
      <div class="header">
        <div class="header-left">
          ...
          <div class="logo-container">
            <img src="veritas-symbol-gold.png" alt="Veritas Global" class="logo-icon" />
            <div class="logo-text-group">
              <span class="logo veritas-logo">VERITAS GLOBAL</span>
              <span class="logo-subtitle">INTELLIGENCE TERMINAL</span>
            </div>
          </div>
          <span class="logo-mobile"><img src="veritas-symbol-gold.png" alt="Veritas Global" class="logo-icon-mobile" /> Veritas Global</span>
          ...
          <nav class="header-nav">
            ...
            <div class="region-selector header-nav-item">
            ...
            <span class="header-nav-divider"></span>
            <a class="header-nav-item" href="https://veritasglobal.co" target="_blank" rel="noopener">About Veritas</a>
          </nav>
        ...
        <div class="header-right">
          ...
          <a class="header-access-btn" href="https://veritasglobal.co/contact" target="_blank" rel="noopener">Request Access</a>
        </div>
      </div>
      <div class="mobile-menu-overlay" id="mobileMenuOverlay"></div>
      <nav class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">VERITAS GLOBAL</span>
        ...
        <button class="mobile-menu-item mobile-menu-variant active" data-variant="full">
          ...
          <span class="mobile-menu-item-label">Dashboard</span>
          <span class="mobile-menu-check">✓</span>
        </button>
        <button class="mobile-menu-item" id="mobileMenuRegion">
          <span class="mobile-menu-item-icon">🌐</span>
          <span class="mobile-menu-item-label">Theaters</span>
        ...
        <div class="mobile-menu-divider"></div>
        <a class="mobile-menu-item" href="https://veritasglobal.co" target="_blank" rel="noopener">
          <span class="mobile-menu-item-icon">🏢</span>
          <span class="mobile-menu-item-label">About Veritas</span>
        </a>
        <a class="mobile-menu-item" href="https://veritasglobal.co/contact" target="_blank" rel="noopener">
          <span class="mobile-menu-item-icon">🔑</span>
          <span class="mobile-menu-item-label">Request Access</span>
        </a>
        <div class="mobile-menu-divider"></div>
        <div class="mobile-menu-footer-links">
          <a href="https://veritasglobal.co" target="_blank" rel="noopener">Veritas Global</a>
          <a href="https://veritasglobal.co/contact" target="_blank" rel="noopener">Contact</a>
        </div>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          <img src="/veritas-symbol-gold.png" alt="" width="28" height="28" class="site-footer-icon" />
          <div class="site-footer-brand-text">
            <span class="site-footer-name">VERITAS GLOBAL</span>
            <span class="site-footer-sub">Intelligence Terminal</span>
          </div>
        </div>
        <nav>
          <a href="https://veritasglobal.co" target="_blank" rel="noopener">About Veritas</a>
          <a href="https://veritasglobal.co/contact" target="_blank" rel="noopener">Request Access</a>
          <a href="https://github.com/Rans-tech/VG-Intelligence-Terminal" target="_blank" rel="noopener">Source Code</a>
        </nav>
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} Veritas Global, LLC &mdash; Built on <a href="https://github.com/koala73/worldmonitor" target="_blank" rel="noopener">World Monitor</a> (AGPL v3)</span>
      </footer>
    `;
  ...
  private createPanels(): void {
    ...
    if (stockAnalysisPanel && !getSecretState('VERITAS_API_KEY').present) {
    ...
    if (stockBacktestPanel && !getSecretState('VERITAS_API_KEY').present) {
    ...
    const _wmKeyPresent = getSecretState('VERITAS_API_KEY').present;
