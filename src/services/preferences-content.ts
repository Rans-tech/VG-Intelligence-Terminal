...
const DESKTOP_RELEASES_URL = 'https://github.com/Rans-tech/VG-Intelligence-Terminal/releases';
...
export function renderPreferences(host: PreferencesHost): PreferencesResult {
  ...
  `;
  html += `<a href="https://github.com/Rans-tech/VG-Intelligence-Terminal/discussions" target="_blank" rel="noopener noreferrer" class="us-discussion-link">
