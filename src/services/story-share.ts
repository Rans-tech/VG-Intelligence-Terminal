...
export const shareTexts = {
  ...
  linkedin: (data: StoryData) =>
    ...
    `\nData via Veritas Global Intelligence Terminal`,
...
export function getShareUrls(data: StoryData): Record<string, string> {
  ...
  return {
    ...
    reddit: `https://reddit.com/submit?url=${encodeURIComponent(url)}&title=${encodeURIComponent(`${data.countryName} Intelligence Brief - Veritas Intel`)}`,
