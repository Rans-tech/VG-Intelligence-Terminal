...
// VITE_VARIANT=tech → tech.intel.veritasglobal.co (tech-focused)
// VITE_VARIANT=full → intel.veritasglobal.co (geopolitical)
// VITE_VARIANT=finance → finance.intel.veritasglobal.co (markets/trading)
