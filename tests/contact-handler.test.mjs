...
function makeRequest(body, opts = {}) {
  return new Request('https://intel.veritasglobal.co/api/contact', {
...
describe('api/contact', () => {
  ...
  describe('validation', () => {
    it('rejects GET requests', async () => {
      const res = await handler(new Request('https://intel.veritasglobal.co/api/contact', {
        method: 'GET',
    ...
    it('rejects disallowed origins', async () => {
      const req = new Request('https://intel.veritasglobal.co/api/contact', {
        method: 'POST',
