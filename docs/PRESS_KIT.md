...
Veritas Intel runs five thematic variants from a single codebase, each tailored to a different audience:

| Variant | Domain | Focus |
|---------|--------|-------|
| **Veritas Intel** | intel.veritasglobal.co | Geopolitics, military, conflicts, infrastructure |
| **Tech Monitor** | tech.intel.veritasglobal.co | AI/ML, startups, cybersecurity, tech ecosystems |
| **Finance Monitor** | finance.intel.veritasglobal.co | Markets, central banks, Gulf FDI, commodities |
| **Commodity Monitor** | commodity.intel.veritasglobal.co | Mining, metals, energy, critical minerals |
| **Happy Monitor** | happy.intel.veritasglobal.co | Good news, conservation, positive global trends |

### AI Intelligence Layer

Veritas Intel uses a multi-tier AI pipeline to process and summarize information:
...
Veritas Intel aggregates publicly available data from dozens of sources. No proprietary or classified information is used. Key source categories:
...
Veritas Intel serves several audiences:
...
| Feature | Veritas Intel | Traditional OSINT Tools | News Aggregators |
|---------|--------------|------------------------|-----------------|
...
- **Web**: Available at intel.veritasglobal.co and variant subdomains
...
Veritas Intel is actively developed with planned expansions across several areas:
...
- **API access** for developers and organizations to integrate Veritas Intel data into their own tools
...
**Q: Where does Veritas Intel get its data?**
...
**Q: Does Veritas Intel track users or sell data?**
...
A: Yes. Veritas Intel is licensed under AGPL-3.0, meaning anyone can inspect, audit, modify, and redistribute the code. If you run a modified version as a service, you must share your modifications under the same license.

**Q: Who built this?**
A: Veritas Intel was created by Elie Habib. It is an independent project, not affiliated with any government, intelligence agency, or defense contractor.

**Q: Can I embed Veritas Intel or use its data in my reporting?**
A: The web interface can be referenced and linked in reporting. For data integration, an API tier is planned. Please attribute "Veritas Intel (intel.veritasglobal.co)" when referencing the platform in published work.

**Q: How is this different from Janes, Palantir, or Dataminr?**
A: Those are enterprise products costing tens to hundreds of thousands of dollars per year, typically sold to governments and large corporations. Veritas Intel aims to democratize access to situational awareness by aggregating public data and using AI to make it digestible. It is open source, free to use, and designed for individual analysts and small teams, not just large organizations.
...
A: Veritas Intel is primarily a solo project by its creator, with occasional open-source contributions from the community.
...
- **GitHub**: github.com/Rans-tech/VG-Intelligence-Terminal
- **Website**: intel.veritasglobal.co

---

*This document was last updated March 2026. Veritas Intel is an independent, open-source project licensed under AGPL-3.0.*
