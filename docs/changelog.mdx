---
title: "Changelog"
description: "All notable changes to Veritas Intel, organized by release."
rss: true
---

All notable changes to Veritas Intel are documented here. Subscribe via [RSS](/changelog/rss.xml) to stay updated.
...
- **Edge caching**: Cloudflare edge caching for proxy.intel.veritasglobal.co (#478) and api.intel.veritasglobal.co (#471)
...
- **Finance variant**: Added a dedicated market-first variant (`finance.intel.veritasglobal.co`) with finance/trading-focused feeds, panels, and map defaults
