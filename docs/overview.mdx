...
description: "Veritas Intel platform variants, capabilities, and specialized monitoring configurations for geopolitical and technology intelligence."
---
Veritas Intel runs five specialized variants from a single codebase, each optimized for different monitoring needs.

## Platform Variants

| Variant | URL | Focus |
|---------|-----|-------|
| **🌍 Veritas Intel** | [intel.veritasglobal.co](https://intel.veritasglobal.co) | Geopolitical intelligence, military tracking, conflict monitoring, infrastructure security |
| **💻 Tech Monitor** | [tech.intel.veritasglobal.co](https://tech.intel.veritasglobal.co) | Technology sector intelligence, AI/startup ecosystems, cloud infrastructure, tech events |
| **😊 Happy Monitor** | [happy.intel.veritasglobal.co](https://happy.intel.veritasglobal.co) | Curated positive news, global progress tracking, science breakthroughs, conservation wins |
| **💰 Finance Monitor** | [finance.intel.veritasglobal.co](https://finance.intel.veritasglobal.co) | Global markets, stock exchanges, central banks, commodities, forex, crypto, economic indicators |
| **⛏️ Commodity Monitor** | [commodity.intel.veritasglobal.co](https://commodity.intel.veritasglobal.co) | Commodity markets, mining sites, processing plants, supply chains, trade flows |
...
The tech variant ([tech.intel.veritasglobal.co](https://tech.intel.veritasglobal.co)) provides specialized layers for technology sector monitoring.
...
The finance variant ([finance.intel.veritasglobal.co](https://finance.intel.veritasglobal.co)) provides specialized layers for global financial markets and economic intelligence.
...
The commodity variant ([commodity.intel.veritasglobal.co](https://commodity.intel.veritasglobal.co)) focuses on mining, metals, energy commodities, and critical mineral supply chains.
...
The happy variant ([happy.intel.veritasglobal.co](https://happy.intel.veritasglobal.co)) curates positive news, human progress data, and uplifting stories.
