...
If you discover a security vulnerability in Veritas Intel, please report it responsibly:

1. **GitHub Private Vulnerability Reporting**: Use [GitHub's private vulnerability reporting](https://github.com/Rans-tech/VG-Intelligence-Terminal/security/advisories/new) to submit your report directly through the repository.
...
Veritas Intel is a client-side intelligence dashboard that aggregates publicly available data. Here are the key security areas:
...
- Veritas Intel aggregates publicly available OSINT data
...
- Vulnerabilities in the Veritas Intel codebase
...
Thank you for helping keep Veritas Intel and its users safe! 🔒
